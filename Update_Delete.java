...
public class Update_Delete {
	...
	public static void updateRecord() throws SQLException {
		...
		String updateTableQuery = "UPDATE cuaca SET nama_cuaca = 'Berawan' WHERE id_cuaca = '2'";
		...
		try {
			...
			System.out.println(recordCount + " record telah berhasil diupdate pada tabel cuaca!");	
		}
